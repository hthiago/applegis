...
export const MODULOS = [
  ...
  },
  {
    ...
    singular: 'peça',
    descricao: 'Projetos, emendas, pareceres e discursos escritos pela equipe, do rascunho ao protocolo.',
    ordenar: { campo: 'atualizadoEm', dir: 'desc' },
    busca: ['titulo', 'tema'],
    campos: [
  ...
  },
  {
    ...
    descricao: 'O que o mandato já defendeu sobre cada assunto — a consulta que responde a imprensa em segundos.',
    ordenar: { campo: 'data', dir: 'desc' },
    busca: ['tema', 'resumo'],
    campos: [
